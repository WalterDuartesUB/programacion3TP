...
public class PanelFichaCamposVuelo extends JPanel{
	...
	private void agregarItemsEnComboAviones() {
		...
		vaciarCampoComboBox(getComboAvion());
	...
	private void agregarItemsEnComboOrigenyDestino() {
		...
		vaciarCampoComboBox(getComboDestino());
	...
	getComboEstado().setSelectedIndex(-1);
	}
	
	
	public void vaciarCampoComboBox( JComboBox<String> combo ) {
